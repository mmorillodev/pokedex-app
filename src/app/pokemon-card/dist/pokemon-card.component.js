...
var PokemonCardComponent = /** @class */ (function () {
    ...
    PokemonCardComponent.prototype.sendInfoByState = function () {
    ...
    PokemonCardComponent.prototype.startPokemonFetch = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.makeGetRequest(this.url)];
                    case 1:
                        response = _a.sent();
    ...
    PokemonCardComponent.prototype.extractRefIdFromPokemonUrl = function () {
        var splittedUrl = this.url.split('/');
        this.pokemonRefId = Number(splittedUrl[splittedUrl.length - 2]);
    };
    __decorate([
        core_1.Input()
    ], PokemonCardComponent.prototype, "name");
    __decorate([
        core_1.Input()
...
exports.PokemonCardComponent = PokemonCardComponent;
